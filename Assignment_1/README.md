...
- All CSV files are stored in the [data folder](https://github.com/ilkabret/LowPowerES/tree/main/Assignment_1/data).
...
- Upload the Arduino sketch TinyML_Application.ino (including /model.h) from the [TinyML_Application folder](https://github.com/ilkabret/LowPowerES/tree/main/Assignment_1/TinyML_Application) to the board.
