...
- and studies **energy-aware inference strategies** under simulated limited or variable power budgets.
...
MVTec AD dataset
↓
Stage 1 — Train a compact convolutional autoencoder on the **MVTec AD** dataset
↓
Stage 2 — Compression Strategies
├── L1 / Taylor pruning
...
└── AUROC / latency / SRAM / Flash measurement
↓
